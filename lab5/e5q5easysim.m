...
Rs=32.05; B=8.1805e-6; Kt = 25.5e-3; Kb = 25.5e-3;
J = 1.34e-6;  
...
id1 = 0.06276; id2 = 0.1466;
id = id2;     % Desired armature current in A.
...
subplot(3,1,1), plot(t,id - ip(1:size(t,2)),"linewidth",1), 
ylabel('Tracking error id - i [A]'); grid(gca,'minor');

subplot(3,1,2), plot(t,ip(1:size(t,2)),"linewidth",1), 
ylabel('Current [A]'); grid(gca,'minor');

subplot(3,1,3), plot(t(1:size(yc,2)),yc,"linewidth",1), 
