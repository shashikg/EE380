...
Rs=32.05; B=8.1805e-6; Kt=25.5e-3; Kb=25.5e-3; J=1.34e-6;
...
tfin = 10;      % seconds.
OLsys = series(con,plant);
[err,t2] = step(feedback(tf(1,1),OLsys),tfin,0.001);
[u,t2] = step(feedback(con,plant),tfin,0.001);
% u is the controller output (plant input).
[y,t1] = step(feedback(series(con,plant),tf(1,1)),tfin,0.001); 
